...
- [ ] امکان درج و مدیریت تصویر
- [ ] پشتیبانی از حالت تاریک (Dark Mode)
- [ ] درج لیست‌های تو در تو و تودرتو
- [ ] خروجی JSON و HTML
- [ ] یکپارچه‌سازی با shadcn/ui Form (react-hook-form) برای استفاده در فرم‌های بزرگ

## 🤝 مشارکت

از مشارکت شما در بهبود این پروژه استقبال می‌شود. لطفاً:
...
توجه: لطفاً پیش از ارسال PR، `bun run lint` و `bun run format` را اجرا کنید تا کد با استانداردهای پروژه هماهنگ باشد. پوشه `.husky` پس از نصب وابستگی‌ها به‌صورت خودکار این بررسی‌ها را روی کامیت‌ها انجام می‌دهد.
