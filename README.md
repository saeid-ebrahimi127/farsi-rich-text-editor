...
- **جاسازی ویدئو (IFrame)**: سیستم چندتامتدیایی با اعتبارسنجی کد IFrame و پشتیبانی از آپارات (قابل توسعه برای سرویس‌های ویدئویی دیگر)
...
| فایل                                       | توضیح                                              |
| ------------------------------------------ | -------------------------------------------------- |
| `extensions/video-iframe.ts`               | نود سفارشی برای جاسازی ویدئو با سیستم چندتامتدیایی |
...
│   ├── components/
│   │   ├── video-iframe-dialog.tsx      # دیالوگ جاسازی ویدئو
